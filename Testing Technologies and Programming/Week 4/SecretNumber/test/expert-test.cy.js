describe('template spec', () => {
    it('passes', () => {
      ...
      cy.get("button#expert").contains("Expert").click();
  
      //Check if we have the content game
      cy.get("div#contentGame");
      cy.get("span#chancesLevel").should("contain", "1 to 100");
      cy.get("input#myInput");
      cy.get("button#go").should("contain", "Go");
      cy.get("span#chancesLeft").should("contain", "10");
      ...
      cy.get("span#result");
      cy.get("span#chancesLeft").should("contain", "9");
    })
  })